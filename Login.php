...
?>
    ...
    <head>
        ...
        <script type="text/javascript">
            function popUpForget() {
                alert("ลิ้งค์เพื่อreset รหัสผ่านถูกส่งไปยังอีเมล์เรียบร้อยแล้ว");
            }
        </script>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br>
              <p class="text-center "><a data-toggle="modal " data-target="#myModal " style="color: white ">ลืมรหัสผ่าน?</a> | <a href="Register.php " style="color: white ">สมัคร์สมาชิก</a></p>
              <br> 
